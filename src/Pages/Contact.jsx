...
export function Contact() {
  return (
    ...
    <div className="bg-customGreen py-10 text-white">
      <h1 className="text-center font-semibold text-4xl sm:text-5xl">GET IN TOUCH</h1>
      <div className="sm:flex sm:mt-20 mt-10 w-6/12 sm:max-lg:w-9/12 mx-auto justify-between">
        <div className=" text-center mb-5 sm:mb-0 space-y-1">
          <IoLocation className="text-5xl mx-auto" />
          <h1 className="font-bold sm:text-2xl text-xl">ADDRESS</h1>
        ...
        <div className=" text-center mb-5 sm:mb-0">
          ...
          <h1 className="font-bold mt-4 sm:text-2xl text-xl">PHONE</h1>
          <h1 className="text-lg">
        ...
        <div className="text-center space-y-1">
          ...
          <h1 className="font-bold sm:text-2xl text-xl">EMAIL</h1>
          <h1 className="text-lg">
    ...
    <div className="sm:w-9/12 w-11/12 sm:flex border-black mt-7 mb-7 mx-auto ">
        ...
        <div className=" pl-2 w-6/12">
            ...
            <div className="border w-fit px-2 py-1 font-semibold bg-yellow-300">Submit</div>
        </div>
    </div>
    <Footer/>
    </>
